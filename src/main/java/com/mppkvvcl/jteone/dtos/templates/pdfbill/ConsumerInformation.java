...
public class ConsumerInformation {
    ...
    public ConsumerInformation(String consumerNo, String consumerName, String address, String consumerNameHindi, String addressHindi, String mobileNo, String emailId, String employeeNo, String status) {
        this.consumerNo = consumerNo;
        this.consumerName = consumerName;
        this.address = address;
        this.consumerNameHindi = consumerNameHindi;
